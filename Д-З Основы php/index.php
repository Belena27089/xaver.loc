...
$books = array(
    array('title'=>'"Наследники богов"','author'=>'Рик Риордан','pages'=>'300'),
    array('title'=>'"Два капитана"','author'=>'Вениамин Каверин','pages'=>'200'));
    
echo 'Недавно я прочитала две книги  '. $books[0]['title'].' и '.$books[1]['title']. ', написанную автороми  '.$books[0]['author'].' и '.$books[1]['author'].', я осилила в сумме '.($books[0]['pages']+$books[1]['pages']).' страниц, не ожидала от себя такого.';
